...
from dcspy.server_exceptions import ServerError, LddsMessageError
...
class TestLddsMessage(unittest.TestCase):
    ...
    def test_parse_create(self):
        ...
        parsed_message = LddsMessage.parse(b"FAF0n00049A081B07E24204153353G30-0NN096WUB00012`BST@KZ@KZh ")
    ...
    def test_message_with_inconsistent_length(self):
        parsed_message = LddsMessage.parse(b"FAF0n00049A081B07E24204153353G30-0NN096WUB00012`BST@KZ@K")
        with self.assertRaises(LddsMessageError) as _:
            self.assertEqual(str(parsed_message.error), "Inconsistent LDDS message length")
